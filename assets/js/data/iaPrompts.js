/* ============================================
   data/iaPrompts.js
   The 35 fixed IA prompts students choose from for the
   TOK Exhibition, as published in the IB TOK Guide (p. 40).
   These do not change between sessions. Stored here so
   exhibition tools can offer a dropdown rather than
   requiring students to retype the prompt exactly — exact
   wording matters, since the Guide requires the prompt to
   be used verbatim, unaltered.

   NOTE: schools occasionally receive guide updates; if your
   copy of the current Guide differs from this list, defer to
   your teacher's copy as the source of truth.
   ============================================ */
...
export const IA_PROMPT_OPTIONS = IA_PROMPTS.map((p) => ({ value: p, label: p }));
